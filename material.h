...
class material {
	public:
		virtual bool sample(const ray& r_in, const hit_record& rec, vec3& attenuation, ray& scattered, float& pdf_val) const = 0;
...
class lambertian : public material {
	public:
		...
		virtual bool sample(const ray& r_in, const hit_record& rec, vec3& attenuation, ray& scattered, float& pdf_val) const;
